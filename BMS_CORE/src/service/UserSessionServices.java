...
public class UserSessionServices {
	...
	public static boolean Sessionservices(String mainPageInput) throws Exception{
		try{
            ...
            throw new ServiceBasedExceptions("Error in providing session srvices for login or signup", e);
        }
	...
	private static void forLogin() throws Exception{
		try{
            ...
            throw new ServiceBasedExceptions("Error in providing service for Login services", e);
        }
	}
}
