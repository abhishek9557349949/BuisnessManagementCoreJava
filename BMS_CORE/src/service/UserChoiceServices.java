...
public class UserChoiceServices {
	...
	public static boolean userSelectedChoice(String userChoice, String UserRole) throws SQLException, InterruptedException, ServiceBasedExceptions{
